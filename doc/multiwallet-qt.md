...
Only requiring some minor changes is bluehost.cpp.
...
Changes to bluehost.cpp
----------------------
bluehost.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
