...
Format: ```mngovernance prepare proposal-name url payment-count block-start bluehost-address monthly-payment-bluehost```
...
Format: ```mngovernance submit proposal-name url payment-count block-start bluehost-address monthly-payment-bluehost fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using bluehost.conf setup)
