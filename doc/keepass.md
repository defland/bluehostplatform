...
Sample initialization flow from _bluehost-qt_ console (this needs to be done only once to set up the association):
 ...
 - You should get a response like this "_Association successful. Id: mydrkwalletbluehost - Key: AgQkcs6cI7v9tlSYKjG/+s8wJrGALHl3jLosJpPLzUE=_"
 - Edit _bluehost.conf_ and fill in these values
```
keepass=1
...
Extended guide with screenshots is also available: https://bluehosttalk.org/threads/keepass-integration.3620/
