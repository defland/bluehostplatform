...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"bluehostaddress\"\n"
            "\nReturn information about the given bluehost address.\n"
            "\nArguments:\n"
            "1. \"bluehostaddress\"     (string, required) The bluehost address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"bluehostaddress\", (string) The bluehost address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"bluehostaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"bluehostaddress\"  (string, required) The bluehost address to use for the signature.\n"
