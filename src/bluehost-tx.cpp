...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Bluehost Core bluehost-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bluehost-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bluehost transaction") + "\n" +
                               "  bluehost-tx [options] -create [commands]   " + _("Create hex-encoded bluehost transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bluehost transaction
